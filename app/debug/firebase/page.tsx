  ...
  return (
    <div className="container py-10">
      ...
      <p className="mb-6 text-muted-foreground">
        Esta página mostra o status da configuração do Firebase e ajuda a diagnosticar problemas.
      </p>
      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Verifique se a API key está correta nas variáveis de ambiente ou no arquivo de configuração.
          </p>
        </div>

        <div className="space-y-2">
          <h3 className="font-medium">5. Erro "Missing or insufficient permissions"</h3>
          <p className="text-sm text-muted-foreground">
            Verifique as regras de segurança do Firestore e Storage. Por padrão, elas exigem autenticação.
          </p>
        </div>

        <div className="space-y-2">
          <h3 className="font-medium">6. Erro "No Firebase App '[DEFAULT]' has been created"</h3>
          <p className="text-sm text-muted-foreground">
            Este erro ocorre quando você tenta usar serviços do Firebase antes de inicializar o Firebase. Verifique se o
            Firebase está sendo inicializado corretamente antes de usar qualquer serviço.
          </p>
        </div>
      </div>
    </div>
